...
const ifos: Ifo[] = [
  ...
  },
  {
    ...
    isActive: false,
    name: 'Soteria (wSOTE)',
    subTitle: 'A blockchain based mutual to share the risk of DeFi on Harmony One',
    description:
  ...
  },
  {
    ...
    description:
      'Ditto is the first elastic supply token on the Harmony One. Its goal is to maintain a stable price of $1, where its supply will adapt to changes in demand. All supply changes will apply equally to every wallet holding Ditto, and holders should always have the same % of the total supply',
    launchDate: 'Dec. 23',
    launchTime: '3PM SGT',
