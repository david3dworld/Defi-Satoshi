...
import { Modal, Text, Button, Flex, InjectedModalProps } from '@satoshicrypto/uikit'
import history from 'routerHistory'
import { delay } from 'lodash'
import useI18n from 'hooks/useI18n'
import confetti from 'canvas-confetti'
import { nfts as nftList } from 'config/constants'
...
const bullNft = nftList[chainId].find((nft) => nft.bunnyId === BULL_NFT)
const hiccupNft = nftList[chainId].find((nft) => nft.bunnyId === HICCUP_NFT)
