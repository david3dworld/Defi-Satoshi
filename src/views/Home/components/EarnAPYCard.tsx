...
import { Heading, Card, CardBody, Flex, ArrowForwardIcon, Skeleton } from '@satoshicrypto/uikit'
...
const EarnAPYCard = () => {
  ...
  const calculateAPY = useCallback(
    (farmsToDisplay) => {
      const cakePriceVsBNB = new BigNumber(farmsLP.find((farm) => farm.pid === CAKE_POOL_PID[chainId])?.tokenPriceVsQuote || 0)
      ...
      farmsToDisplay.map((farm) => {
        ...
        if (farm.quoteTokenSymbol === quoteTokenBUSD) {
