...
const StyledLotteryCard = styled(Card)`
  background-image: url('/images/satoshicrypto-lottery-ticket-opacity.png');
  ...
  return (
    <StyledLotteryCard>
      <CardBody>
        ...
        <CardImage src="/images/satoshicrypto-lottery-ticket.png" alt="cake logo" width={64} height={64} />
        <Block>
