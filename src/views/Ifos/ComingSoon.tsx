...
import { Button, Text } from '@satoshicrypto/uikit'
  ...
  return (
    <Page>
      ...
      <Content>
        <div>
          <Block>
            <Title as="h2">{TranslateString(999, 'Coming Soon to Satoshi.')}</Title>
            <Text mb={3}>
              {TranslateString(
                504,
            ...
            <Text mb={3}>
              <LiquidityLink href="https://swap.satoshicrypto.finance/#/add/ETH/0x4Ee80372D69260d72826f6e8F2351201618709Ae">
                {TranslateString(506, 'Get CAKE-BNB LP >')}
              </LiquidityLink>
            </Text>
            <Text mb={3}>
              {TranslateString(508, 'The project gets the BNB, Satoshi burns the SAT.')}
              <br />
