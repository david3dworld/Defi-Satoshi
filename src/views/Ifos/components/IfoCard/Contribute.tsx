...
import { Box, Button, Flex, Text, useModal } from '@satoshicrypto/uikit'
...
const Contribute: React.FC<ContributeProps> = ({
  ...
  const contributedBalance = getBalanceNumber(userInfo.amount, 'TODO')
  const { toastSuccess } = useToast()

  const handleContributeSuccess = (amount: BigNumber) => {
    toastSuccess('Success!', `You have contributed ${getBalanceNumber(amount, 'TODO')} CAKE-BNB LP tokens to this IFO!`)
