...
import { Modal, LinkExternal, Box } from '@satoshicrypto/uikit'
...
const ContributeModal: React.FC<Props> = ({ currency, contract, currencyAddress, onDismiss, onSuccess }) => {
  ...
  const balance = getBalanceNumber(useTokenBalance(currencyAddress), 'TODO')
  ...
  return (
    <Modal title={`Contribute ${currency}`} onDismiss={onDismiss}>
      <Box width="344px">
        ...
        />
        <LinkExternal
          href="https://https://swap.satoshicrypto.finance/#/add/ETH/0x4Ee80372D69260d72826f6e8F2351201618709Ae"
