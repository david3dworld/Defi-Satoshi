...
import { Heading, CardBody, CardFooter, PancakeRoundIcon, TicketRound, PancakesIcon } from '@satoshicrypto/uikit'
      ...
      <>
        <CardBody>
          <CardHeading>
            ...
            <LotteryCardHeading
              valueToDisplay={TranslateString(999, `${poolSize.toLocaleString()} SAT`)}
              Icon={PancakesIcon}
            >
