...
import { Image, Card, CardBody } from '@satoshicrypto/uikit'
        ...
        <CardBody>
          <StyledCardContentInner>
            ...
            {/* <RabbitRow>
              <RabbitBox>
                <CardImageFirst>
                  <Image src="/images/Only Ticket.png" alt="Number 1" width={100} height={100} responsive />
                </CardImageFirst>
              </RabbitBox>
              <RabbitBox>
                <CardImage style={{ marginLeft: '-1.2em' }}>
                  <Image src="/images/Only Ticket.png" alt="Number 2" width={150} height={150} responsive />
                </CardImage>
              </RabbitBox>
              <RabbitBox>
                <CardImage style={{ marginLeft: '-1.2em' }}>
                  <Image src="/images/Only Ticket.png" alt="Number 3" width={150} height={150} responsive />
                </CardImage>
              </RabbitBox>
              <RabbitBox>
                <CardImage style={{ marginLeft: '-1.2em' }}>
                  <Image src="/images/Only Ticket.png" alt="Number 4" width={150} height={150} responsive />
                </CardImage>
              </RabbitBox>
            </RabbitRow> */}
            <RabbitRowSmall>
