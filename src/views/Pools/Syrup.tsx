...
import { Heading, Text, Flex } from '@satoshicrypto/uikit'
...
const Farm: React.FC = () => {
  ...
  const poolsWithApy = pools.map((pool) => {
    ...
    const totalStakingTokenInPool = stakingTokenPriceInBNB.times(getBalanceNumber(pool.totalStaked, pool.tokenName))
  ...
  return (
    <Page>
      <Hero>
        <div>
          <ul>
            <li>{TranslateString(580, 'Stake SAT to earn new tokens.')}</li>
