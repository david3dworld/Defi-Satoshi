...
import { Button, IconButton, useModal, AddIcon, Image, Flex, Text } from '@satoshicrypto/uikit'
...
console.log('-- PoolCard pool.totalValue : ', pool.totalValue.toNumber());
    ...
    <Card isActive={isCardActive} isFinished={isFinished && sousId !== 0}>
      ...
      <div style={{ padding: '24px' }}>
        ...
        {!isOldFinishedBush && !isOldSyrup ? (
          <BalanceAndCompound>
            <Balance value={getBalanceNumber(earnings, tokenName)} isDisabled={isFinished} />
        ...
        <StyledDetails>
          <div style={{ flex: 1 }}>
            {pool.stakingTokenName === 'SAT' && (
              <img src="/images/farms/sat.png" alt="SAT Token" width="15" height="15" />
            )}
            {TranslateString(384, 'Your Stake')}:
          </div>
          <Balance fontSize="14px" isDisabled={isFinished} value={getBalanceNumber(stakedBalance, stakingTokenName)} />
        </StyledDetails>
        {blocksUntilStart > 0 && (
          <StyledDetails>
