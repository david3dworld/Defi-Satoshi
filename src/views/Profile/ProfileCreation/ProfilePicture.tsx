...
import { AutoRenewIcon, Button, Card, CardBody, Heading, Skeleton, Text } from '@satoshicrypto/uikit'
...
const ProfilePicture: React.FC = () => {
  ...
  const walletNfts = nftList[chainId].filter((nft) => bunnyIds.includes(nft.bunnyId))
