...
import { Button, Flex, Text, InjectedModalProps } from '@satoshicrypto/uikit'
      ...
      <Flex alignItems="center" style={{ height: '48px' }} justifyContent="center">
        <Text as="p" color="failure">
          {!hasMinimumCakeRequired &&
            TranslateString(999, `${getFullDisplayBalance(numberCakeToUpdate, 'CAKE')} CAKE required to change profile pic`)}
        </Text>
      </Flex>
      {profile.isActive ? (
        <>
