...
const StyledTotalReferralsCard = styled(Card)`
...
const TotalReferralsCard = () => {
  ...
  if( !account ) return <></>
  return (
    <StyledTotalReferralsCard>
      <CardBody>
        <Actions>
          <div>
            <HeaderText fontSize="20px">Total Referrals</HeaderText>
            <hr style={{border: '1px solid #6565bb'}}/>
            <DescriptionText fontSize="14px" color="textSubtle">{`${referrals}`}</DescriptionText>
          </div>
        </Actions>
      </CardBody>
    </StyledTotalReferralsCard>
